from aim.utils import DetectionModel, Evaluator, VideoAnalysis
...
if __name__ == '__main__':
    ...
    video_analysis = VideoAnalysis(os.path.join(args.dataset, 'val.json'), args.input, args.output, args.threshold, dict(x=crop[2], y=crop[3], w=crop[0], h=crop[1]))
    video_analysis.run(model)
